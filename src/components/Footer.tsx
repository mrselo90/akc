...
const Footer = ({ contactInfo, services, footerData }: any) => {
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="flex flex-col md:flex-row items-center justify-center space-y-2 md:space-y-0 md:space-x-6">
            <div className="flex items-center text-lg font-bold">
              ...
              {footerData?.emergencyBanner || 'ACİL DURUM HATTI - 7/24 HİZMET'}
            </div>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed text-lg">
                {footerData?.description || '30 yıllık deneyimimizle sigorta hasarlarında güvenilir çözüm ortağınız. Konut ve işyeri hasarlarında profesyonel onarım hizmetleri sunuyoruz.'}
              </p>
