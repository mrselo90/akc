          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4 p-6 bg-gray-50 rounded-2xl hover:bg-gray-100 transition-colors">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-1">Telefon</h4>
                                    <a href={`tel:${siteData.contactInfo.phone}`} className="text-orange-600 hover:text-orange-700 font-medium">
                  {siteData.contactInfo.phone}
                </a>
                    <p className="text-gray-500 text-sm mt-1">7/24 Acil Müdahale</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 p-6 bg-gray-50 rounded-2xl hover:bg-gray-100 transition-colors">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-1">E-posta</h4>
                                    <a href={`mailto:${siteData.contactInfo.email}`} className="text-blue-600 hover:text-blue-700 font-medium">
                  {siteData.contactInfo.email}
                </a>
                    <p className="text-gray-500 text-sm mt-1">24 saat içinde yanıt</p>
                  </div>
                </div>
                ...
                <p className="text-gray-500 text-sm mt-1">{siteData.contactInfo.workingHours}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-red-50 border-l-4 border-red-500 p-6 rounded-lg">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <h4 className="text-lg font-bold text-red-800">🚨 Acil Durum Hattı</h4>
                  <p className="text-red-700 mb-3">7/24 acil müdahale için hemen arayın</p>
                  <a
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="konut-hasar">Konut Hasar Onarımı</option>
                  <option value="isyeri-hasar">İşyeri Hasar Onarımı</option>
