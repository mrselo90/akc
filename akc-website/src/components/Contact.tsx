          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-6">
                {/* Phone */}
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 p-6 bg-gray-50 rounded-2xl hover:bg-gray-100 transition-colors group w-full">
                ...
                {siteData.contactInfo.whatsapp && (
                  <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 p-6 bg-green-50 rounded-2xl hover:bg-green-100 transition-colors group w-full">
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 p-6 bg-gray-50 rounded-2xl hover:bg-gray-100 transition-colors group w-full">
                  ...
                  <div className="flex flex-col items-center sm:items-start w-full">
                    ...
                    <address className="text-gray-600 not-italic text-center sm:text-left w-full">{siteData.contactInfo.address[language]}</address>
